...
import { ServicesWrapper } from '../../styles/components/home/blockPresentation'
  ...
  return (
    <ServicesWrapper>
      ...
      <p>
        ...
        pouvons comprendre à quel point il est important en 2020 aux
      ...
      <p>
        ...
        informations sur où se trouve tel restaurant, quel film passe en
        ...
        prospects et développer son activité est contrainte d’être présente sur
        internet.
      </p>
    </ServicesWrapper>
  )
