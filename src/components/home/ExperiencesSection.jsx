  ...
  return (
    <ExperiencesWrapper>
      ...
      <p>
        ...
        très spécifiques. Pour faire économiser du temps de et de l’argent à mes
        clients j'ai également beaucoup travaillé avec des{' '}
        <strong>C.M.S.</strong> : Wordpress, Prestashop, Drupal, Magento. En
        effet ces outils robustes et soutenus par des communautés regroupant des
        millions d’utilisateurs, offrent des solutions clés en mains pour
        répondre à vos attentes pour la création de site vitrine ou la création
        de site e-commerce.
      </p>
    </ExperiencesWrapper>
  )
