...
import { MentionsWrapper } from '../styles/pages/mentions'
import { MainTitle } from '../styles/common/title'

const NotFoundPage = () => (
  <Layout>
    <SEO title="Mentions légales du site de Johan Petrikovsky développeur web à Toulouse" />
    <MentionsWrapper>
      ...
      <p>
        ...
        site{' '}
        <a href="https://www.developpeur-web.tech/">www.developpeur-web.tech</a>{' '}
        l'identité des différents intervenants dans le cadre de sa réalisation
        et de son suivi :
      </p>
      <p>
        <strong>Propriétaire</strong> : Johan Petrikovsky – Particulier – 51
        avenue de Lespinet 31400 Toulouse
        <br />
        <strong>Créateur</strong> :{' '}
        <a href="httpss://www.developpeur-web.tech">Johan Petrikovsky</a>
        <br />
        <strong>Responsable publication</strong> : Johan Petrikovsky –
        0615373595
        <br />
        Le responsable publication est une personne physique ou une personne
        morale.
        <br />
        <strong>Webmaster</strong> : Johan Petrikovsky – 0615373595
        <br />
        <strong>Hébergeur</strong> : Netlify – Netlify 610 22nd Street, Suite
        315, San Francisco, CA 94107
        <br />
        Crédits : johan petrikovsky
      </p>
      <h3>
      ...
      <p>
        ...
        décidée par Johan Petrikovsky, qui s’efforcera alors de communiquer
        préalablement aux utilisateurs les dates et heures de l’intervention.
      </p>
      <p>
        Le site{' '}
        <a href="https://www.developpeur-web.tech/">www.developpeur-web.tech</a>{' '}
        est mis à jour régulièrement par Johan Petrikovsky. De la même façon,
      ...
      <p>
        Johan Petrikovsky s’efforce de fournir sur le site{' '}
        <a href="https://www.developpeur-web.tech/">www.developpeur-web.tech</a>{' '}
      ...
      <p>
        Johan Petrikovsky est propriétaire des droits de propriété
      ...
      <p>
        ...
        préalable de : Johan Petrikovsky.
      </p>
      <p>
      ...
      <p>
        Johan Petrikovsky ne pourra être tenue responsable des dommages directs
        et indirects causés au matériel de l’utilisateur, lors de l’accès au
        site www.developpeur-web.tech, et résultant soit de l’utilisation d’un
        matériel ne répondant pas aux spécifications indiquées au point 4, soit
        de l’apparition d’un bug ou d’une incompatibilité.
      </p>
      <p>
        Johan Petrikovsky ne pourra également être tenue responsable des
      ...
      <p>
        ...
        l’espace contact) sont à la disposition des utilisateurs. Johan
        Petrikovsky se réserve le droit de supprimer, sans mise en demeure
        ...
        relatives à la protection des données. Le cas échéant, Johan Petrikovsky
      ...
      <p>
        {' '}
        En tout état de cause Johan Petrikovsky ne collecte des informations
      ...
      <p>
        ...
        rachat de Johan Petrikovsky et de ses droits permettrait la transmission
      ...
      <p>
        ...
        en place avec l’autorisation de Johan Petrikovsky. Cependant, Johan
        Petrikovsky n’a pas la possibilité de vérifier le contenu des sites
